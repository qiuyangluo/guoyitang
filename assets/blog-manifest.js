  ...
  posts: [
    {
      ...
      title: "神经系统和经络有什么区别？现代解剖与中医整体观的通俗说明",
      date: "2026-07-02",
      excerpt:
        "神经系统是现代医学可解剖、可测量的信号网络；经络是中医理解气血运行、脏腑联系与体表反应的整体模型。二者有交集，但不能简单画等号。",
      author: "国医堂",
    },
    {
      slug: "lixia-food-therapy-tcm",
      title: "立夏节气常见食疗：养心健脾、清暑祛湿怎么吃",
      date: "2026-06-27",
      excerpt:
        "立夏后暑热渐近、湿气渐重，食疗宜清而不寒、补而不腻。梳理绿豆百合汤、山药薏米粥、冬瓜扁豆汤、莲子小米粥等家常思路，并说明体质慎用与就医提醒。",
      author: "国医堂",
    },
    {
      slug: "summer-heat-health-tips-tcm",
      title: "夏季养生小贴士：防暑、护脾胃、稳睡眠",
      date: "2026-06-18",
      excerpt:
        "夏季防暑补水、空调避直吹、饮食护脾胃、睡眠与运动节奏，以及哪些症状需要及时就医。纽约法拉盛国医堂中医养生科普，须辨证面诊，非个体化处方。",
      author: "国医堂",
    },
    {
    ...
    },
    {
      ...
      date: "2026-05-05",
      excerpt:
        "肾、肝、脾与冲任气血如何影响周期与经量；肾虚、肝郁、脾虚、血热、血瘀、痰湿等病机通俗说明；生活诱因与何时优先现代医学。纽约国医堂健康科普，须辨证面诊。",
      author: "guoyitang11366@gmail.com",
    },
    {
      slug: "lixia-solar-term-wellness",
      title: "立夏养生：清心养阳、健脾祛湿",
      date: "2026-05-05",
      excerpt:
        "立夏心气渐旺、暑湿渐生，宜养心清火、顾护脾阳、清淡饮食、午间小憩与适度汗出；过敏体质与胃肠虚弱者尤须个体化调养。国医堂节气科普，以面诊为准。",
      author: "guoyitang11366@gmail.com",
    },
    {
    ...
    },
    {
      ...
      date: "2026-03-28",
      excerpt:
        "春季节律变化与失眠：肝郁、心脾两虚等辨证、针灸与睡眠卫生、何时就诊法拉盛；长文科普，非个体化处方。",
      author: "国医堂",
    },
    {
      slug: "neck-back-pain-acupuncture",
      title: "颈肩腰痛何时考虑针灸？纽约中医诊所的常见评估要点",
      date: "2026-03-21",
      excerpt:
        "颈肩腰痛的中医气血经络思路、严重警示症状与影像时机、针灸推拿配合与日常防护；纽约法拉盛就诊参考，长文科普。",
      author: "国医堂",
    },
  ],
};
